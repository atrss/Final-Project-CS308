...
var getPractice = function() {
  if(problem>=configurations.length){
    var feedback = '<div class="centerv"> <div class = "text2">To download the data for your experiment, press the button below.<br> Your score for the experiment is: '+ points +'</div>'
    ...
    // var TimeTaken = '<div  class = "text2"> <p>You took ' + time1 + 's for problem number: '+ (problem+1) + '</p></div> <br>';
    var canvas = '<div class = "tol_canvas tol_vertical_line"></div>'
